...
export default function ForgotPasswordScreen() {
  ...
  const handleSendLink = () => {
    ...
    // also check this email is used in created acc
    // Implement your backend reset link dispatch mechanism here
      ...
      >
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            <View style={[styles.inputWrapper, { borderColor: colors.border || "#E5E7EB" }]}>
            ...
            <TouchableOpacity 
              style={[styles.primaryButton, { backgroundColor: colors.primary || "#4F46E5" }]}
